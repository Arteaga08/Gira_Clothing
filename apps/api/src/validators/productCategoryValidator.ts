...
const productCategoryListQuerySchema = listQueryBase.keys({ isActive: Joi.boolean() });

export { createProductCategorySchema, updateProductCategorySchema, productCategoryListQuerySchema };
